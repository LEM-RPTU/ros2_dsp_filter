...
class SignalFilter(Node):
    ...
    def __init__(self):
        ...
        self.sample_time_subscription = self.create_subscription(self.message_type, self.params.topic, self.sample_time_subscription_callback, qos_profile=self.qos_profile)
    ...
    def sample_time_subscription_callback_(self, msg):
        if(self.number_of_messages_received == 0):
            ...
            self.publisher = self.create_publisher(self.message_type, self.params.topic + "/filtered", qos_profile=self.qos_profile)
